# Entwicklertools
Um die Entwicklertools einzublenden, muss man den `Slider` betätigen und die App neustarten.
...
Nach einem Neustart stehen euch folgende Dialoge neu zur Verfügung:

- App
- Info's (Reiter: Systeminfos)
- Updates
- Logs
<br>
...
Hier wird nur der `Retro.I-Service` heruntergefahren bzw. neu gestartet. 

![App Neu Starten](../assets/user-manual/entwicklertools/entwicklertools_5.jpg)
