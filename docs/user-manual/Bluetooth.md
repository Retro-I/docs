...
## TODO Bild Geräteverbunden

Wie in `Bluetooth-Einstellungen` üblich ist es auch möglich den Anzeigenamen des Raspberry Pi's anzupassen.

## TODO BT Name anpassen